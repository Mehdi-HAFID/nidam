...
/**
 * SQL (JPA) configuration for the Nidam token generator module. This class is retained for documentation purposes,
 ...
 *   <li>Entity classes under {@code nidam.tokengenerator.entities.sql} are scanned</li>
...
@Configuration
@Profile("sql")
@EnableJpaRepositories(basePackages = "nidam.tokengenerator.repositories.sql")
@EntityScan(basePackages = "nidam.tokengenerator.entities.sql")
