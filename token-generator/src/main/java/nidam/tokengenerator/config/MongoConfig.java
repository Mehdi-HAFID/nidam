...
/**
 * MongoDB configuration for the Nidam token generator module. This class is retained for documentation purposes,
 ...
 * {@code nidam.tokengenerator.repositories.mongo}.
 *
...
@Configuration
@Profile("mongo")
@EnableMongoRepositories(basePackages = "nidam.tokengenerator.repositories.mongo")
