...
This BFF exists to support Nidam’s primary objective — providing a secure, OAuth 2.0–based web application by handling authentication flows, 
token management, and frontend‑specific API needs.
